...
namespace Crozy.Infrastructure.Migrations
{
    ...
    [Migration("20240711110230_AddColumnsForCustomerDetailsNamesOrder")]
    partial class AddColumnsForCustomerDetailsNamesOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crozy.Domain.ExtraOptionCategories.ExtraOptionCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ExtraOptionCategories");
                });

            modelBuilder.Entity("Crozy.Domain.ExtraOptions.ExtraOption", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ExtraOptionCategoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ExtraOptionCategoryId");
            ...
            modelBuilder.Entity("Crozy.Domain.Products.ProductExtraOptionLink", b =>
                {
                    b.Property<long>("ExtraOptionId")
                        .HasColumnType("bigint");

                    b.Property<long>("ProductId")
                        .HasColumnType("bigint");

                    b.HasKey("ExtraOptionId", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("ProductExtraOptionLinks");
                });
            ...
            modelBuilder.Entity("Crozy.Domain.ExtraOptions.ExtraOption", b =>
                {
                    b.HasOne("Crozy.Domain.ExtraOptionCategories.ExtraOptionCategory", null)
                        .WithMany()
                        .HasForeignKey("ExtraOptionCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.OwnsOne("Crozy.Domain.Moneys.Money", "Price", b1 =>
                        {
                            b1.Property<long>("ExtraOptionId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("ExtraOptionId");

                            b1.ToTable("ExtraOptions");
            ...
            modelBuilder.Entity("Crozy.Domain.Orders.Order", b =>
                {
                    ...
                    b.OwnsOne("Crozy.Domain.Moneys.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<long>("OrderId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Crozy.Domain.Orders.PaymentState", "PaymentState", b1 =>
                        {
                            ...
                            b1.HasIndex("PaymentTransactionId");
                            ...
                            b1.HasOne("Crozy.Domain.Payments.PaymentTransaction", null)
                                .WithMany()
            ...
            modelBuilder.Entity("Crozy.Domain.Orders.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Crozy.Domain.Moneys.Money", "OrderItemTotalPrice", b1 =>
                        {
                    ...
                    b.OwnsOne("Crozy.Domain.Moneys.Money", "ProductPrice", b1 =>
                        {
                            b1.Property<long>("OrderItemId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsMany("Crozy.Domain.Orders.OrderItemExtraOption", "ExtraOptions", b1 =>
                        {
                            b1.Property<long>("OrderItemId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasIndex("ExtraOptionId");

                            b1.ToTable("OrderItemExtraOptions");

                            b1.HasOne("Crozy.Domain.ExtraOptions.ExtraOption", null)
                                .WithMany()
                                .HasForeignKey("ExtraOptionId");
                            ...
                            b1.OwnsOne("Crozy.Domain.Moneys.Money", "Price", b2 =>
                                {
                                    b2.Property<long>("OrderItemExtraOptionOrderItemId")
                                        .HasColumnType("bigint");

                                    b2.Property<int>("OrderItemExtraOptionId")
                                        .HasColumnType("integer");
                                    ...
                                    b2.HasKey("OrderItemExtraOptionOrderItemId", "OrderItemExtraOptionId");

                                    b2.ToTable("OrderItemExtraOptions");

                                    b2.WithOwner()
                                        .HasForeignKey("OrderItemExtraOptionOrderItemId", "OrderItemExtraOptionId");
                                });
                    ...
                    b.Navigation("OrderItemTotalPrice")
                        .IsRequired();
            ...
            modelBuilder.Entity("Crozy.Domain.Products.ProductExtraOptionLink", b =>
                {
                    b.HasOne("Crozy.Domain.ExtraOptions.ExtraOption", null)
                        .WithMany()
                        .HasForeignKey("ExtraOptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
