const ForgotPasswordPage = () => {
  ...
  return (
    <>
      <link href={new URL('/static/azureB2C/combinedSignInAndSignUp.css', homePageUrl).toString()} rel="stylesheet" type="text/css" data-preload="true"/>
            ...
            <div className="panel panel-default">
              <div className="panel-body">
                ...
                <div className="heading">
                  <h1 role="heading">Resetare Parola</h1>
                </div>
